...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='blog',
            name='posted',
            field=models.DateTimeField(db_index=True, default=datetime.datetime(2023, 4, 27, 16, 12, 2, 666706), verbose_name='Опубликована'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(db_index=True, default=datetime.datetime(2023, 4, 27, 16, 12, 2, 667731), verbose_name='Дата комментария')),
