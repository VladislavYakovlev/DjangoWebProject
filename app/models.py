...
class Blog(models.Model):
    ...
    image = models.FileField(default= '../../static/app/content/Icone_site.jpg', verbose_name= "Путь к картинке")  
    ...
    class Meta:
        ...
        ordering = ["-posted"] # порядок сортировки данных модели ("-" означает по убыванию)

        verbose_name = "Статья блога" # Имя под которым модель будет отображаться в административном отделе(для одной статьи)

        verbose_name_plural = "Статьи блога" # Тоже самое, но для всех статей 
